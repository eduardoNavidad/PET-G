       <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url().'administrador/gestion_usuarios/roles'; ?>">roles</a></li>
    ...
    <section class="content">
        ...
        <div class="container-fluid">           
            <div class="row">
                ...
                <form  class="form-horizontal" action="<?php echo base_url();?>administrador/gestion_usuarios/guardar_rol" method="POST">
