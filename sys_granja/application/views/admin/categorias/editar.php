    ...
    <section class="content">
        ...
        <div class="container-fluid">           
            <div class="row">
                ...
                <form  class="form-horizontal" action="<?php echo base_url();?>administrador/categorias/modificar" method="POST">
                  <input type="hidden" value="<?php echo $categoria->id;?>" name="idCategoria">
                    <div class="card-body">
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Nombre</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="nombre" name="nombre" maxlength="45" value="<?php echo $categoria->nombre?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="descripcion" name="descripcion" maxlength="100"  value="<?php echo $categoria->descripcion?>" required>
                                </div>
                            </div>
